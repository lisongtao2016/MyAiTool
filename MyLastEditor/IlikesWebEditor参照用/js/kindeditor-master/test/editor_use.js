...
KindEditor.ready(function (K) {
    ...
    ArrKindEditor.push(editor);

    editor.html  (parent.document.getElementById("kindEdiorHTML").value);
    //equals(editor.html(), parent.document.getElementById("kindEdiorHTML").value);
